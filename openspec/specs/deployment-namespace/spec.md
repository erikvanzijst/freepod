# deployment-namespace Specification

## Purpose

Every deployment is provisioned into its own Kubernetes namespace. This capability defines how that namespace is generated and stored, why it is unique and immutable, and why it stays internal to the platform.
